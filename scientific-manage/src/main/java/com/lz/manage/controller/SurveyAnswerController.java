...
public class SurveyAnswerController extends BaseController
{
    ...
    @Log(title = "用户填写的完整问卷记录", businessType = BusinessType.EXPORT)
    @PostMapping("/export")
    public void export(HttpServletResponse response, SurveyAnswerQuery surveyAnswerQuery)
    {
        ...
        util.exportExcel(response, list, "用户填写的完整问卷记录数据");
    }
    ...
    @Log(title = "用户填写的完整问卷记录", businessType = BusinessType.INSERT)
    @PostMapping
    ...
    @Log(title = "用户填写的完整问卷记录", businessType = BusinessType.UPDATE)
    @PutMapping
    ...
    @Log(title = "用户填写的完整问卷记录", businessType = BusinessType.DELETE)
	@DeleteMapping("/{ids}")
