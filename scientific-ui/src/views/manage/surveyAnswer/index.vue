  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="surveyAnswerList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="编号" align="center" v-if="columns[0].visible" prop="id" />
        ...
        <el-table-column label="题目" :show-overflow-tooltip="true" align="center" v-if="columns[2].visible" prop="questionId" />
        ...
        <el-table-column label="答案" :show-overflow-tooltip="true" align="center" v-if="columns[4].visible" prop="answer" />
        <el-table-column label="用户" :show-overflow-tooltip="true" align="center" v-if="columns[5].visible" prop="userId" />
        <el-table-column label="部门" :show-overflow-tooltip="true" align="center" v-if="columns[6].visible" prop="deptId" />
        <el-table-column label="题目顺序" :show-overflow-tooltip="true" align="center" v-if="columns[7].visible" prop="questionOrder" />
...
<script>
import { listSurveyAnswer, getSurveyAnswer, delSurveyAnswer, addSurveyAnswer, updateSurveyAnswer } from "@/api/manage/surveyAnswer";
