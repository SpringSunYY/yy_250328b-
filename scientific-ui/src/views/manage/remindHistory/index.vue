  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="remindHistoryList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="编号" align="center" v-if="columns[0].visible" prop="id" />
        ...
        <el-table-column label="内容" :show-overflow-tooltip="true" align="center" v-if="columns[2].visible" prop="content" />
        <el-table-column label="部门" :show-overflow-tooltip="true" align="center" v-if="columns[3].visible" prop="deptId" />
...
<script>
import { listRemindHistory, getRemindHistory, delRemindHistory, addRemindHistory, updateRemindHistory } from "@/api/manage/remindHistory";
