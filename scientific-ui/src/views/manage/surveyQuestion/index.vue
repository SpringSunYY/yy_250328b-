  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="surveyQuestionList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="编号" align="center" v-if="columns[0].visible" prop="id" />
        <el-table-column label="答卷" :show-overflow-tooltip="true" align="center" v-if="columns[1].visible" prop="surveyId" />
        ...
        <el-table-column label="题干内容" :show-overflow-tooltip="true" align="center" v-if="columns[3].visible" prop="questionTitle" />
        <el-table-column label="题目内容" :show-overflow-tooltip="true" align="center" v-if="columns[4].visible" prop="questionOptions" />
        <el-table-column label="题目顺序" :show-overflow-tooltip="true" align="center" v-if="columns[5].visible" prop="questionOrder" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="题目内容" prop="questionOptions">
          <el-input v-model="form.questionOptions" type="textarea" placeholder="请输入内容" />
        </el-form-item>
        <el-form-item label="题目顺序" prop="questionOrder">
...
<script>
import { listSurveyQuestion, getSurveyQuestion, delSurveyQuestion, addSurveyQuestion, updateSurveyQuestion } from "@/api/manage/surveyQuestion";
