        ...
        <pane size="84">
          <el-col>
            ...
            <el-row :gutter="10" class="mb8">
              ...
              <el-col :span="1.5">
                <el-button type="danger" plain icon="el-icon-delete" size="mini" :disabled="multiple"
                           @click="handleDelete" v-hasPermi="['system:user:remove']"
                >删除
                </el-button>
              </el-col>
              <el-col :span="1.5">
            ...
            <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
              ...
              <el-table-column label="体重" align="center" prop="weight" v-if="columns[7].visible"/>
              <el-table-column label="身高" align="center" prop="height" v-if="columns[8].visible"/>
  ...
  data() {
    return {
      ...
      columns: [
        ...
        { key: 6, label: `身高`, visible: true },
        { key: 6, label: `体重`, visible: true },
